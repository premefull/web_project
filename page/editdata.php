...
$R_room=$_GET["R_room_no"];
$sql = "SELECT * FROM room WHERE R_room_no = $R_room";
...
<?php  if(isset($_SESSION)):?>
    <div class="success">
        ...
        <?php endif ?>
    <form class="modal-content animate"  method="post" action="editdatadb.php"
    enctype="multipart/form-data">

    <div class="container">

        <label ><b>เลขที่ห้องเรียน</b></label>
        <input placeholder="เช่น 618/1 ให้ใส่ 6181" type="text" name="R_room_no" pattern="[0-9]{1,}" value="<?=$room['R_room_no']?>">
